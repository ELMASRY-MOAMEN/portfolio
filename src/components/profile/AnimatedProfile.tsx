  ...
  return (
    ...
    >
      ...
      {badges?.certifications && (
        ...
        >
          <div className="glassmorphism flex items-center gap-2 p-3 rounded-xl">
            ...
            <div>
              <div className="text-xs text-gray-500">{locale === 'fr' ? 'Certifié' : 'Certified'}</div>
              <div className="font-bold">{badges.certifications}</div>
            </div>
          </div>
        </motion.div>
      )}
      ...
      {badges?.experience && (
        ...
        >
          <div className="glassmorphism flex items-center gap-2 p-3 rounded-xl">
            ...
            <div>
              <div className="text-xs text-gray-500">{locale === 'fr' ? 'Expérience' : 'Experience'}</div>
              <div className="font-bold">{badges.experience}</div>
            </div>
          </div>
        </motion.div>
      )}
      ...
      {badges?.projects && (
        ...
        >
          <div className="glassmorphism flex items-center gap-2 p-3 rounded-xl">
            ...
            <div>
              <div className="text-xs text-gray-500">{locale === 'fr' ? 'Projets' : 'Projects'}</div>
              <div className="font-bold">{badges.projects}</div>
            </div>
          </div>
        </motion.div>
      )}
