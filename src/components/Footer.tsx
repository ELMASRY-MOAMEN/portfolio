        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2 animate-fade-up">
            ...
            <div className="mt-6 flex space-x-4" itemScope itemType="https://schema.org/Person">
              ...
              <a 
              <a href="https://github.com/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors" aria-label="GitHub">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            ...
            <ul className="space-y-2 font-bricolage">
              <li className="flex items-start">
                ...
                <a href="mailto:contact@monportfolio.fr" className="text-gray-300 hover:text-white transition-colors">
